...
document.querySelectorAll(".medtab").forEach((tab) => {
  tab.addEventListener("click", function () {
    document
      .querySelectorAll(".medtab")
      .forEach((t) => t.classList.remove("active"));

    document
      .querySelectorAll(
        "#medicaldentalhistory, #familymedicalhistory, #personalsocialhistory, #menstrualHistory, #physicalExamination, #diagnosticResults"
      )
      .forEach((content) => {
        content.style.display = "none";
      });
...
function preparePdfData() {
  document.getElementById("input_patient_name").value = document
    .getElementById("name")
    .innerText.trim();
  document.getElementById("input_patient_age").value = document
    .getElementById("age")
    .innerText.trim();
  document.getElementById("input_patient_address").value = document
    .getElementById("address")
    .innerText.trim();
  document.getElementById("input_patient_course").value = document
